Простая программа, которая парсит сайт Московского метро (HTML страницу) и создаёт JSON-файл со списком линий (номер ветки и название) и станций (номер линии и список станций на ней). 
